        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full">
            ...
            <Input
              id="taxId"
              type="text"
              placeholder="US59342585"
              className="h-12 rounded-xl border border-gray-300 bg-white px-4 text-sm placeholder:text-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none"
            />
          </div>
