  ...
  return (
    <div className="flex flex-col w-full p-4 border border-[#E5E5E5] rounded-xl bg-[#FCFCFC] space-y-2">
      ...
      <div className="flex flex-wrap gap-2 ">
        {status === "Pending" ? (
          <>
            <Button className="w-full sm:w-[145px] lg:w-[150px] h-12 px-10 rounded-xl bg-[#192D4E] text-white text-base font-medium hover:bg-[#14233a] transition cursor-pointer">
              Respond
            </Button>
            <Button
              variant="outline"
              className=" w-full sm:w-[200px] lg:w-[205px]  h-12 px-10 rounded-xl border border-[#192D4E] text-[#192D4E] hover:bg-[#f4f4f4] transition cursor-pointer"
            >
              Mark as Resolved
            </Button>
          </>
