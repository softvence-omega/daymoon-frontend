    ...
    <div className="w-full ">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-8 items-start lg:items-center mb-10 w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 w-full lg:w-auto">
          ...
          <Button
            asChild
            className="h-[50px] w-full sm:w-auto px-6 md:px-10 py-[10px] gap-2 rounded-[20px] bg-[var(--color-sunset-orange)] text-white flex items-center justify-center text-[16px] md:text-[18px] font-medium font-poppins leading-[130%] shadow-md hover:shadow-lg transition"
          >
            <Link
              to="/seller-dashboard/create-promotion"
