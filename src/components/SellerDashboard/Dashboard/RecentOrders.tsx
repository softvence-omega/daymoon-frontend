        ...
        <Table className="w-full min-w-[600px] md:min-w-full">
          <TableHeader>
            <TableRow className="text-[#666666]">
              <TableHead className="w-[120px] md:w-[150px] px-2 md:px-4 py-2">
                Order ID
              </TableHead>
              <TableHead className="pl-4 md:pl-8 lg:pl-32 py-2">
                Customer
              </TableHead>
          ...
          <TableBody className="text-[#1A1A1A]">
            {orderData.map((order) => (
              <TableRow key={order.id}>
                <TableCell className="font-medium px-2 md:px-4 py-3 md:py-4">
                  {order.orderId}
                </TableCell>
                <TableCell className="pl-4 md:pl-8 lg:pl-32 py-3 md:py-4">
                  {order.name}
                </TableCell>
                <TableCell className="px-2 md:px-4 py-3 md:py-4">
                  {order.orderDate}
                </TableCell>
                <TableCell className="text-right pr-4 md:pr-8 py-3 md:py-4">
                  {order.totalAmount}
                </TableCell>
              </TableRow>
            ))}
