...
const SearchByImage = () => {
  ...
  return (
    <motion.div
      ...
      className="flex items-center ml-4  px-6 rounded-full shadow-[0_0_1px_0px_#F46A39] h-17 bg-white"
    >
      <button
        type="button"
        onClick={handleButtonClick}
        className="flex items-center gap-2 text-sm md:text-base text-[#1A1A1A] font-normal focus:outline-none"
        disabled={loading}
      >
        <img alt="fileSearch" src={fileSearch} className="w-5 h-5" />
