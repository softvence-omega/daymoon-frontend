...
const BuyerOrdersPage: React.FC<OrdersTableProps> = () => {
  ...
  const filteredOrders = BuyerOrderTable.filter((order) => {
    const matchesSearch =
    ...
    <div className="max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div className="relative">
          <select
            className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-8 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none"
            value={statusFilter}
